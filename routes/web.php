...
Route::group(['middleware' => 'web'], function() {
    ...
    Route::group(['middleware' => 'auth'], function() {
        ...
        Route::get('/browse/{subject}/{past_paper}/{paper_question}',
            function (App\Subject $subject, App\PastPaper $past_paper, App\PaperQuestion $paper_question) {
        ...
        Route::post('/post_create_question',
            'PostCreateQuestionController@store')->middleware('auth')->name('post_question');
        Route::post('/post_suggest_date',
            'PostSuggestDateController@store')->middleware('auth')->name('post_suggest_date');
